    ...
    function ($q, $injector, $http) {
      ...
      return ChRequestBuilder = function () {
        ...
        ChRequestBuilder.prototype.extractFrom = function (source, type) {
          var params;
          params = _.isArray(source) && type === 'collection' ? this._extractMemberArray(source) : type === 'collection' ? this._extractCollection(source) : this._extractMember(source);
        ...
        ChRequestBuilder.prototype._extractMemberArray = function (source) {
          var action, mappings, result, values;
          if (_.isEmpty(source)) {
            return {};
          }
          action = this.$context.member_action('get');
          mappings = action.mappings;
          values = _.map(source, function (_this) {
            return function (obj) {
