        ...
        function ChActionOp($parent, $type, $action, $params) {
          ...
          success = function (_this) {
            return function () {
              ...
              if (_.isNull(_this.$type) && (association = _this.$parent.$associationProperty)) {
  ...
  angular.module('chinchilla').factory('ChRequestBuilder', [
    ...
    function ($q, $injector, $http) {
      ...
      return ChRequestBuilder = function () {
        ChRequestBuilder.init = function (context, subject, type, action, params) {
          var klass;
          klass = function () {
            switch (type) {
            case 'member':
          ...
          return new klass(context, subject, type, action, params);
        };
    ...
    function ($q, ChRequestBuilder) {
      ...
      return ChMemberRequestBuilder = function (_super) {
        ...
        ChMemberRequestBuilder.prototype.buildUriParams = function () {
          var params, values;
          params = {};
          values = _.merge({}, this.extractAttributes(), this.$params);
          _.each(this.$contextAction.mappings, function (_this) {
            return function (mapping) {
              var value;
              if (mapping.source) {
                value = values[mapping.source] || _this.$subject && _this.$subject[mapping.source];
                if (!value) {
                  return;
                }
                return params[mapping.variable] = value;
