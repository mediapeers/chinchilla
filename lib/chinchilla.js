  ...
  angular.module('chinchilla').factory('ChContext', function () {
    ...
    return ChContext = function () {
      ...
      ChContext.prototype.member_action = function (name) {
        var context;
        context = this.data && this.data['@context'];
        return context && context.member_actions && context.member_actions[name];
      };
      ChContext.prototype.collection_action = function (name) {
        var context;
        context = this.data && this.data['@context'];
        return context && context.collection_actions && context.collection_actions[name];
      };
      return ChContext;
    }();
  });
    ...
    function ($q, ChRequestBuilder) {
      ...
      return ChMemberRequestBuilder = function (_super) {
        ...
        ChMemberRequestBuilder.prototype.extractAttributes = function () {
          ...
          uriAttrs = template.fromUri(this.$subject['@id']);
          result = {};
        ...
        ChMemberRequestBuilder.prototype.buildUrl = function () {
          var uriAttrs, uriTmpl;
          uriTmpl = new UriTemplate(this.$contextAction.template);
          uriAttrs = {};
          _.each(this.$contextAction.mappings, function (_this) {
            return function (mapping) {
              var value;
              value = _this.$subject && _this.$subject[mapping.source];
              if (!value) {
                return;
              }
              return uriAttrs[mapping.variable] = value;
            };
          }(this));
          return uriTmpl.fillFromObject(uriAttrs);
        };
    ...
    function ($q, ChRequestBuilder) {
      ...
      return ChCollectionRequestBuilder = function (_super) {
        ...
        ChCollectionRequestBuilder.prototype.extractAttributes = function () {
          ...
          template = new UriTemplate(get.template);
          mappings = get.mappings;
          uriAttrs = _.map(this.$subject, function (obj) {
            return template.fromUri(obj['@id']);
          });
          result = {};
          _.each(mappings, function (mapping) {
            var _name;
        ...
        ChCollectionRequestBuilder.prototype.buildUrl = function () {
          var uriAttrs, uriTmpl;
          uriTmpl = new UriTemplate(this.$contextAction.template);
          uriAttrs = {};
          _.each(this.$contextAction.mappings, function (_this) {
            return function (mapping) {
              ...
              uriAttrs[_name = mapping.variable] || (uriAttrs[_name] = []);
              return _.each(_this.$subject, function (obj) {
                ...
                return uriAttrs[mapping.variable].push(value);
              });
            };
          }(this));
          return uriTmpl.fillFromObject(uriAttrs);
